...
def show_model_information_page():
    ...
    st.write('- Tampak tidak ada perubahan signifikan antara sebelum dan sesudah menggunakan GAN + Feature Selection. Hal tersebut karena jumlah data yang sudah mencukupi dan semua feature memiliki peran yang penting. ')
    ...
    st.write('- Catboost menghasilkan akurasi tertinggi, yaitu 91.7% pada data test. Hal tersebut karena catboost bisa mengkombinasikan berbagai model yang prediksinya lemah dengan cara menggabungkannya menjadi satu model yang kuat. Berdasarkan alasan tersebut, saya menggunakan model Catboost pada web app ini.')